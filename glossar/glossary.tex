...
\newglossaryentry{glos:prozessexemplar}{
    ...
    description={
        ...
        Es umfasst einen, an ein \gls{glos:geschaeftsprozessmodell} gebundenen, Kontext, welcher Informationen über den aktuellen Abarbeitungsstand des Prozesses enthält}
}
...
\newglossaryentry{glos:thread}{
    ...
    plural={Threads},
    description={
        Ein \emph{Thread} bezeichnet in der Informatik einen Ausführungsstrang innerhalb einer Anwendung.
        Pro Anwendung ist mindestens ein Thread vorhanden, die Threads werden parallel abgearbeitet}
}

\newglossaryentry{glos:deploymentarchiv}{
    name={Deploymentarchiv},
    plural={Deploymentarchive},
    description={
        Ein \emph{Deploymentarchiv} enthält alle für die Ausführung eines Geschäftsprozesses benötigten \glsdisp{glos:prozessartefakt}{Artefakte} und kann in der JodaEngine registriert werden}
}
...
\newglossaryentry{glos:deployment}{
	...
	plural={Deployments},
	description={
        Das \emph{Deployment} eines Geschäftsprozesses ist der Vorgang seines Registrierens mit allen benötigten \glsdisp{glos:prozessartefakt}{Artefakten} in der Prozessengine.}
}

\newglossaryentry{glos:prozessartefakt}{
    name={Prozessartefakt},
    plural={Prozessartefakte},
    description={
        Ein \emph{Prozessartefakt} ist ein Objekt, welches zusätzlich zum formalen Prozessmodell an einer Prozessdefinition hängt.
        Dabei handelt es sich zum Beispiel um Formulardaten oder prozessspezifische Datentypen}
}
...
\newglossaryentry{glos:human-task}{
    ...
    description={
        Eine \emph{Human Task} repräsentiert in der Business Process Model and Notation (BPMN) die Umgebung für Aufgaben, die von menschlichen Ressourcen ausgeführt werden können}
        }

\newglossaryentry{glos:plattform}{
    name={Plattform},
    plural={Plattformen},
    description={
        Mit einer \emph{Plattform} ist im Softwarekontext und speziell in dieser Arbeit die Grundlage eines Softwaresystems gemeint, dass den Kern eines Softwaresystems darstellt und Erweiterbarkeit in den Mittelpunkt der Architektur stellt. Die Erweiterungen können auf dem bestehenden Kern aufbauen, sodass der Arbeitsaufwand neuer Implementierungen stark reduziert wird}
}
