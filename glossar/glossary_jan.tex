...
\newglossaryentry{glos:thread}{
    ...
    description={
        ...
        Pro Anwendung können beliebig viele Threads vorhanden sein, diese werden parallel abgearbeitet}
}
...
\newglossaryentry{glos:deployment}{
	...
	plural={Deployments},
	description={
        Das \emph{Deployment} eines Geschäftsprozesses ist der Vorgang seines Registrierens mit allen benötigten ung eines Geschäftsprozesses benötigten \glsdisp{glos:prozessartefakt}{Artefakten} in der Prozessengine.}
}
