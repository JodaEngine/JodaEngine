...
import org.jodaengine.ext.debugging.listener.DebuggerTokenCreationListener;
...
public class DebuggerServiceViaExtensionServiceTest extends AbstractJodaEngineTest {
    ...
    public void testRequiredComponentsAreAvailable() {
        ...
        Assert.assertTrue(this.extensionService.isExtensionAvailable(DebuggerTokenCreationListener.class));
    }
    ...
    /**
     * Tests that the listener for the {@link DebuggerTokenCreationListener} is successfully provided.
     */
    @Test
    public void testRequiredDebuggerTokenCreationListenerIsProvided() {
        
        List<TokenCreationListener> listeners
            = this.extensionService.getExtensions(TokenCreationListener.class);
        
        Assert.assertFalse(listeners.isEmpty());
        Assert.assertTrue(isTypeContained(listeners, DebuggerTokenCreationListener.class));
    }
